#!/usr/bin/env python3
"""
Fetch FinMind TaiwanStockPrice data and store it into SQLite.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fetch TaiwanStockPrice and store into SQLite."
    )
    ...
    parser.add_argument(
        "--table-name",
        default="stock_price",
        help="Target table name. Default: stock_price",
    )
    parser.add_argument(
        "--replace",
        action="store_true",
